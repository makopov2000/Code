...
public class Shortest_Common_Superstring_Algorithm_1 {

	public static void main(String arg[]) {
		 
        Set<String> fragments = new HashSet<String>();
        Shortest_Common_Superstring_Algorithm_1 superStringCreator = new Shortest_Common_Superstring_Algorithm_1();
